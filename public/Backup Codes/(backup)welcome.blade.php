...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        header {
            background-color: #ffffff; /* Pastikan ada titik koma */
            height: auto;
            /* margin-top: 80px; */ /* <--- HAPUS ATAU KOMENTARI BARIS INI */
            margin-bottom: 40px;
            padding-top: 50px; /* <--- TAMBAHKAN KEMBALI ATAU PASTIKAN NILAI INI ADA */
            /* padding-top: 0px; */ /* Hapus duplikasi jika ada */
            display: flex;
