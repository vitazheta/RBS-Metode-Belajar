...
@section('content')
    ...
    <style>
        ...
        .btn-primary {
            ...
            box-shadow: 0 4px 6px rgba(0,0,0,0.1); /* Tambah shadow */
        }
        ...
        .btn-primary:hover {
            ...
            box-shadow: 0 6px 10px rgba(0,0,0,0.15); /* Shadow lebih besar */
        }
        .btn.mt-3 {
        ...
        max-width: 300px;
        min-width: 280px;
        padding: 30px 20px; /* Tambah padding */
        box-sizing: border-box;
        background-color: #f0f8ff; /* Latar belakang cerah */
        border-radius: 15px; /* Lebih rounded */
        box-shadow: 0 8px 16px rgba(0,0,0,0.1); /* Shadow lebih kuat */
        ...
        .feature-item:hover {
            ...
            box-shadow: 0 12px 24px rgba(0,0,0,0.2); /* Shadow lebih besar saat hover */
        }
        ...
        .icon-circle {
            width: 80px; /* Lebih besar */
             height: 80px; /* Lebih besar */
            border-radius: 50%;
            display: flex;
            align-items: center;
            justify-content: center;
            background: linear-gradient(45deg, #0E1F4D, #84A7CF); /* Gradien warna */
            color: white;
            margin: 0 auto 20px; /* Margin bawah lebih besar */
            font-size: 32px; /* Ikon lebih besar */
            box-shadow: 0 4px 8px rgba(0,0,0,0.2); /* Shadow pada ikon */
            transition: transform 0.3s ease-in-out; /* Transisi untuk ikon */
        }

        body.dark-theme .feature-item .icon-circle {
            background: linear-gradient(45deg, #F37AB0, #E2A6C1); /* Gradien warna di dark mode */
            color: #FFFFFF;
        ...
        body.dark-theme .feature-item {
            background-color: #1B1B1B; /* Latar belakang gelap */
        ...
        .section .features .feature-item p {
            ...
            line-height: 28px;
            color: #0E1F4D;
            max-width: none; /* Hilangkan max-width bawaan */
            margin: 10;
        }
        ...
        @media (max-width: 575.98px) {
            ...
            header p { font-size: 12px; line-height: 18px; padding: 0 5px; margin: 5px auto 10px;}
