...
<head>
    ...
    <title>Pelajari - Rekomendasi Belajar</title>
...
<body>
    ...
    <div class="container-fluid py-2">
        <div class="container-tutorial p-5 bg-white rounded shadow-sm">
            <div class="step mb-5">
            ...
            <div class="step">
                ...
                <img src="{{ asset('images/tutorial/step3.png') }}" alt="Step 3">
            </div>
            <div class="text-center mt-5">
                <p class="fw-bold">Klik tombol di bawah ini untuk memulai</p>
                <a href="{{ route('dashboard.dosen') }}" class="btn btn-start">Mulai</a>
            </div>
        </div>
    </div>
...
.container-fluid {
    padding: 0 15px; /* Opsional: Tambahkan padding jika diperlukan */
    max-width: 100%;
}
...
.btn-start:hover {
    background-color: transparent; /* Transparan saat hover */
    color: #F37AB0; /* Warna teks berubah */
    border: 2px solid #F37AB0; /* Border tetap */
}
</style>
